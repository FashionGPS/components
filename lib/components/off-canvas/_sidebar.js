...
var Sidebar = function (_React$Component) {
  ...
  _createClass(Sidebar, [{
    ...
    value: function onTouchMove(ev) {
      ...
      if (this.isTouching()) {
        ev.targetTouches.forEach(function (touch) {
          if (touch.identifier === _this2.state.touchIdentifier) {
            _this2.setState({
              touchCurrentX: touch.clientX,
              touchCurrentY: touch.clientY
            });
    ...
    value: function render() {
      ...
      if (useTouch) {
        if (this.props.open) {
          ...
          dragHandle = _react2.default.createElement('div', {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('div', {
          className: (0, _classnames2.default)(this.props.overlayClassName, 'overlay', { visible: this.props.overlayVisibility }),
          style: overlayStyle,
